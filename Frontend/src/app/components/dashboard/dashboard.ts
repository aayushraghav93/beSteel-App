...
export class Dashboard {
  ...
  getGraphStats(){
    this.userService.getGraphStats().subscribe(res=>{
      ...
      if(this.activityLineChartRef||this.workoutLineChartRef){
   ...
   new Chart(activityCtx, {
    ...
    data: {
      ...
      datasets: [
        ...
        fill:false,
        borderWidth:2,
        backgroundColor: 'rgba(235,100,100,0.6)',
      ...
      },
      {
        ...
        fill:false,
        borderWidth: 2,
        backgroundColor: 'rgba(235,100,120,0.6)',
        ...
        fill:false,
        borderWidth: 2,
        backgroundColor: 'rgba(255,200,220,0.6)',
